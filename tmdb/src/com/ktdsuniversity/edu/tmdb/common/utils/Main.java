...
public class Main {
	...
	public static void main(String[] args) {
		...
		String query = " SELECT BDGT as bbggddtt, BX_OFFC_GRSS as rvn, MV_ID, TTL, SMMR, MV_RTNG,RLS_DT, MAIN_PSTR_URL, X_URL FROM MV WHERE MV_ID = ? ";
		MvVO mv = dbConn.selectBuilder(MvVO.class, query)
						.setParams(pstmt -> {
							pstmt.setString(1, "1-spider-man-brand-new-day");
						})
						.addRenameColumn("bbggddtt", "BDGT")
						.addRenameColumn("rvn", "BX_OFFC_GRSS")
						.selectOne();
		dbConn.close();
