...
public class Regular implements Custom{
	
	private String name;
	private int wallet;
	private List<Standard> basket;
	private int age;
	public Regular(String name, int wallet, int age) {
		this.name = name;
		this.wallet = wallet;
		this.age = age;
	...
	public void purchase(List<Standard> standard) {
		...
		int[] price = new int[standard.size()];
	...
	public String toString() {
		return "Regular Customer: name: " + this.name + ", money: " + this.wallet + ", basket: " + this.basket
		+ ", age: " + this.age; 
	}
