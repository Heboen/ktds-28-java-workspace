...
public class New implements Custom{
		...
		public void addStuff(Standard standard) {
			this.basket.add(standard);
		}
		...
		public String toString() {
			return "New Customer: name: " + this.name + ", money: " + this.wallet + ", basket: " + this.basket
			+ ", age: " + this.age; 
		}
